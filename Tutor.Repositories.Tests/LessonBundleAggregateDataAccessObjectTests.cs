...
public class LessonBundleAggregateDataAccessObjectTests
{
    ...
    // NOTE: The prorata business rules moved to LessonBundleRepository.AddBundleAsync
    // (quarter layout by BundleCreationMode) and are covered by LessonBundleRepositoryTests.
}
